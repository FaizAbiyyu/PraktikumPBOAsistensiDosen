...
public class PembeliModel_07293 extends ModelAbstrack_07293 {
    ...
    public ArrayList<PembeliEntity07293> pembeli = new ArrayList<>();

    public ArrayList<PembeliEntity07293> getPembeli() {
        return pembeli;
    }

    public void insert (PembeliEntity07293 pembeli) {
        try {
    ...
    public PembeliEntity07293 getpembelibyid(int idGame){
        try {
            ...
            if (rs.next()) {
                PembeliEntity07293 pembeli = new PembeliEntity07293();
