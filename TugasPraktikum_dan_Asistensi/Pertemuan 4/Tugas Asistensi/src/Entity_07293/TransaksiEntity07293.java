...
public class TransaksiEntity07293 extends ManusiaEntity_07293 {
    public int nomortrx;
    public int status;
    ...
    public TransaksiEntity07293(int nomortrx, int status ){
        this.nomortrx = nomortrx;
        this.status = status;
    }

    public TransaksiEntity07293(){}
    ...
    public PembeliEntity07293 getPembeli() {
