import Controller_07293.AdminContorller_07293;
import Controller_07293.ObjectModelController_07293;
import Controller_07293.PembeliController_07293;
import Controller_07293.TransaksiController_07293;
import Entity_07293.PembeliEntity_07293;
import Entity_07293.ProdukEntity_07293;
import Entity_07293.TransaksiEntity_07293;
...
public class App_07293 {
    ...
    public static TransaksiController_07293 transaksi = new TransaksiController_07293();
    public static PembeliController_07293 pembeli = new PembeliController_07293();
    public static AdminContorller_07293 admin = new AdminContorller_07293();
    ...
    public static void showDataProduk(){
        for (ProdukEntity_07293 p: transaksi.showproduk()) {
            System.out.println("===================================");
    ...
    public static void showDataProdukbyid(int id){
            ProdukEntity_07293 p = transaksi.showprodukbyid(id);
            System.out.println("===================================");
    ...
    public static void showDataPembeli(int cek){
        PembeliEntity_07293 pe = pembeli.showpembelibyid(cek);
        System.out.println("===================================");
    ...
    public static void showDataPembeli(){
        for (TransaksiEntity_07293 pem: transaksi.getdatatransaksi()) {
            System.out.println("===================================");
    ...
    static void inserDataPembeli1(){
        ...
        ObjectModelController_07293.pembeliCon.insertpembeli(nama,notelp,ign,akun);
        ObjectModelController_07293.transaksiCon.insertDataPembeli(nama,notelp,ign,akun, produk,nominal,harga);
    }
