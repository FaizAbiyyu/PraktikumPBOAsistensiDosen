...
public class TransaksiController_07293 {
    ...
    public void insertDataPembeli(String nama,String notelp, String idGame,String akun, String namaProduk, int nominal,  int harga ){
        TransaksiEntity_07293 transaksiEntity_07293 = new TransaksiEntity_07293();
    ...
    public ArrayList<TransaksiEntity_07293> transaksibyidgame(int idgame){
    ...
    public ArrayList<TransaksiEntity_07293> getPembeliEn(){
        return ObjectModelController_07293.transaksiMo.getpembeli();
    }

    public ArrayList<TransaksiEntity_07293> getdatatransaksi(){
